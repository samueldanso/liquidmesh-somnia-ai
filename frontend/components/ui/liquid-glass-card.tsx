...
const GLASS_SHADOW_LIGHT =
	'shadow-[0_0_6px_rgba(0,0,0,0.02),0_2px_6px_rgba(0,0,0,0.06),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.4),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.35),inset_1px_1px_1px_-0.5px_rgba(0,0,0,0.3),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.3),inset_0_0_6px_6px_rgba(0,0,0,0.08),inset_0_0_2px_2px_rgba(0,0,0,0.04),0_0_12px_rgba(255,255,255,0.08)]'

const GLASS_SHADOW_DARK =
	'dark:shadow-[0_0_8px_rgba(0,0,0,0.02),0_2px_6px_rgba(0,0,0,0.06),inset_3px_3px_0.5px_-3.5px_rgba(255,255,255,0.05),inset_-3px_-3px_0.5px_-3.5px_rgba(255,255,255,0.35),inset_1px_1px_1px_-0.5px_rgba(255,255,255,0.3),inset_-1px_-1px_1px_-0.5px_rgba(255,255,255,0.3),inset_0_0_6px_6px_rgba(255,255,255,0.08),inset_0_0_2px_2px_rgba(255,255,255,0.04),0_0_12px_rgba(0,0,0,0.08)]'
...
const liquidGlassCardVariants = cva(
	'group relative overflow-hidden bg-background/20 backdrop-blur-[2px] transition-all duration-300 border border-black/5 dark:border-white/5',
	{
		variants: {
			glassSize: {
				sm: 'p-4',
...
function LiquidGlassCard({
	...
	return (
		<Card className={cn(liquidGlassCardVariants({ glassSize }), className)} {...props}>
			...
			<div className="pointer-events-none absolute inset-0 z-20 rounded-lg bg-gradient-to-r from-transparent via-black/5 to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-75 dark:via-white/5" />
		</Card>
	)
}
