...
export default function FeaturesSection() {
	return (
		<section id="features" className="bg-gray-50 py-12 md:py-20 dark:bg-transparent">
			<div className="mx-auto max-w-7xl px-6">
				<div className="mb-10 text-center">
					...
					<p className="text-muted-foreground mt-4 text-balance text-lg max-w-2xl mx-auto">
						Multi-agent AI orchestration that continuously optimizes your concentrated
						liquidity positions across Somnia DEXes
					</p>
				</div>
					...
					<div className="relative z-10 grid grid-cols-6 gap-3">
						<LiquidGlassCard className="relative col-span-full overflow-hidden lg:col-span-2 p-6 flex">
							<div className="relative m-auto size-fit pt-6">
								<div className="relative flex h-24 w-56 items-center">
									...
									>
										<title>Capital Efficiency Chart</title>
										<path
						...
						<LiquidGlassCard className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 p-6">
							<div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
								<Network
									className="m-auto h-fit w-24 text-[#6D6BFF]"
									strokeWidth={1}
								/>
							</div>
							<div className="relative z-10 mt-6 space-y-2 text-center">
								...
								<p className="text-foreground">
									Specialized AI agents (Watcher, Strategist, Executor) coordinate
									autonomously to optimize your liquidity positions.
								</p>
							</div>
						</LiquidGlassCard>
						<LiquidGlassCard className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 p-6">
							...
							<div className="grid pt-0 sm:grid-cols-2">
								<div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
									<div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
										<Brain
											className="m-auto size-5 text-[#6D6BFF]"
											strokeWidth={1}
										/>
									</div>
								...
								<div className="rounded-tl-(--radius) relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6">
									...
									<div className="flex items-center justify-center space-x-4 mt-8">
										<div className="text-center">
											<Brain className="size-8 text-[#6D6BFF] mx-auto mb-2" />
						...
						<LiquidGlassCard className="relative col-span-full overflow-hidden lg:col-span-3 p-6">
							<div className="grid h-full sm:grid-cols-2">
								<div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
									<div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
										<Shield
											className="m-auto size-6 text-[#6D6BFF]"
											strokeWidth={1}
										/>
									</div>
									<div className="space-y-2">
									...
									<div className="relative flex h-full flex-col justify-center space-y-6 py-6">
										<div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
											...
											<div className="ring-background size-7 ring-4">
												<div className="size-full rounded-full bg-gradient-to-br from-[#34A4FF]/20 to-[#A855FF]/20 flex items-center justify-center">
													<Shield className="size-4 text-[#6D6BFF]" />
												</div>
											</div>
										</div>
										<div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
											<div className="ring-background size-8 ring-4">
												<div className="size-full rounded-full bg-gradient-to-br from-[#34A4FF]/20 to-[#A855FF]/20 flex items-center justify-center">
													<TrendingUp className="size-4 text-[#6D6BFF]" />
												</div>
											</div>
											<span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm bg-gradient-to-r from-[#34A4FF]/20 via-[#6D6BFF]/20 to-[#A855FF]/20 text-[#6D6BFF] border-[#6D6BFF]/30">
												Transparent
										...
										<div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
											...
											<div className="ring-background size-7 ring-4">
												<div className="size-full rounded-full bg-gradient-to-br from-[#34A4FF]/20 to-[#A855FF]/20 flex items-center justify-center">
													<Zap className="size-4 text-[#6D6BFF]" />
												</div>
											</div>
										</div>
									</div>
