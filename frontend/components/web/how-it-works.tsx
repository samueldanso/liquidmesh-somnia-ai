import { ArrowUp, Brain, Globe, Network, Play, Plus, Signature, Sparkles, Zap } from 'lucide-react'
				...
				<div className="mx-auto w-full max-w-7xl px-6">
					<div>
						...
						<p className="text-muted-foreground mb-12 mt-4 text-balance text-center text-lg">
							Multi-agent AI orchestration that autonomously manages your concentrated
						...
						<div className="grid items-center gap-6 sm:grid-cols-5">
							...
							<div className="max-w-md sm:col-span-3">
								...
								<p className="text-muted-foreground mt-3 text-balance">
									...
									range status) and sends structured data to the Strategist agent.
								</p>
							</div>
						</div>
	...
	return (
		...
		>
			...
			<div className="bg-white/5 -mx-3 -mb-3 mt-3 space-y-3 rounded-lg p-3 backdrop-blur">
				<div className="text-muted-foreground text-sm">Transaction Status: Success</div>
