...
export default function FAQs() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Yes, LiquidMesh is fully non-custodial and self-custodial. You maintain full control of your funds with no third-party custody or withdrawal limits. All operations are fully on-chain and transparent.",
    },
  ];
